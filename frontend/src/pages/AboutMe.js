...
function AboutMe() {
  ...
  return (
    <section className="relative min-h-screen bg-black overflow-hidden text-white flex items-center justify-center px-6 py-24">
      ...
      {/* Subtle grid overlay */}
      <div
        className="absolute inset-0 z-0 bg-[linear-gradient(90deg,_rgba(255,255,255,0.05)_1px,_transparent_1px),_linear-gradient(rgba(255,255,255,0.05)_1px,_transparent_1px)] bg-[size:24px_24px] transition-all duration-75 ease-out"
        style={{
      ...
      >
        ...
        >
          Merging tech, design, and full stack development to build expressive,
          high-impact experiences.
        </motion.p>

        <motion.a
          href="#projects"
          className="inline-block px-6 py-3 bg-gradient-to-r from-green-500 to-cyan-700 text-white font-semibold rounded-full shadow-lg hover:scale-105 transition-transform"
